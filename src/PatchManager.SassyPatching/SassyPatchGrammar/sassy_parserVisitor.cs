...
public interface Isassy_parserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitExpression_indexer([NotNull] sassy_parser.Expression_indexerContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMap_indexer([NotNull] sassy_parser.Map_indexerContext context);
	/// <summary>
