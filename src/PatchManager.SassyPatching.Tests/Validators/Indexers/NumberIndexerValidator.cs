...
/// <summary>
/// Describes a validator for matching nodes of type <see cref="NumberIndexer"/>
/// </summary>
public class NumberIndexerValidator : ParseValidator<NumberIndexer>
{
    /// <summary>
    /// A field that is used to match against the corresponding field in a node of type <see cref="NumberIndexer"/>
    /// </summary>
    public ulong Index;
    /// <summary>
