...
/// <summary>
/// Describes a validator for matching nodes of type <see cref="ClassIndexer"/>
/// </summary>
public class ClassIndexerValidator : ParseValidator<ClassIndexer>
{
    /// <summary>
    /// A field that is used to match against the corresponding field in a node of type <see cref="ClassIndexer"/>
    /// </summary>
