...
/// <summary>
/// Describes a validator for matching nodes of type <see cref="MergeValue"/>
/// </summary>
public class MergeValueValidator : ParseValidator<MergeValue>
{
    /// <summary>
    /// A validator that is used to match against the corresponding node in a node of type <see cref="MergeValue"/>
    /// </summary>
