...
/// <summary>
/// Describes a validator for matching nodes of type <see cref="IntersectionSelector"/>
/// </summary>
public class IntersectionSelectorValidator : ParseValidator<IntersectionSelector>, IEnumerable<ParseValidator>
{
    ...
    public override bool Validate(IntersectionSelector node)
    {
